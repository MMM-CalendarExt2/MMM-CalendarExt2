...
# View:legend
The purpose of this view is to show a calendar legend of all calendars displayed in the view.
 It uses the same classes as all other views to form a legend.
...
<div class="module fake_module MMM-CalendarExt2 CX2 shown">
  ...
  <div class="module-content">
    <div class="view legend">
      <div class="legend-slot event garmin" data-calendar-name="Garmin">
      ...
      <div class="legend-slot event work" data-calendar-name="Work">
      ...
      <div class="legend-slot event home" data-calendar-name="Home">
